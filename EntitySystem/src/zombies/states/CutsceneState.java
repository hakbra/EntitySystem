...
public class CutsceneState {
	...
	public static void init(World world)
	{
		...
		worldEntity.components.add(new CollisionPolygon( new Point(0, 0), new Point(GLEngine.WIDTH, 0)));
		...
		exit.components.add(new Tex("exit.png", new Point(30, 30)));
		...
		exit2.components.add(CollisionPolygon.centerRectangle(new Point(50, 50)));
		exit2.components.add(new Trigger("exit2"));
		exit2.components.add(new Tex("exit.png", new Point(30, 30)));
